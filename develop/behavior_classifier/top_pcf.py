...
te_to=   ['Mouse159_20161017_18-28-46',
          'Mouse163_20161017_20-23-25',
          'Mouse162_20161018_17-57-56',
          'Mouse059_20160526_17-54-59',
          'Mouse161_20161018_19-29-26',
          'Mouse076_20160709_17-46-10',
          'Mouse158_20161017_18-02-32',
          'Mouse159_20161018_16-21-18']
...
for clf_n in range(1,2):
    for d in range(3):
        ...
        # video_path = '/home/segalinc/MARS/tomomi_miniscope/'
        ...
        ver=6
        f = open(savedir + 'log_selection.txt', 'wb')
        original = sys.stdout
        ...
        for b in range(n_classes):
            ...
            #1. train
            # mlp = MLPClassifier(solver='adam', alpha=0.0001, hidden_layer_sizes=(256, 512), random_state=1,
                               # learning_rate='adaptive', max_iter=100000,learning_rate_init=.001, verbose=0)
            # clf = BaggingClassifier(mlp, max_samples=.1, n_jobs=-1, random_state=7, verbose=0)
            # clf = XGBClassifier(n_estimators=500, random_state=1, n_jobs=-1)
